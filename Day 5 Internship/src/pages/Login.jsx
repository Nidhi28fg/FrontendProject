...
function Login() {
  return (
    <div class="flex justify-center items-center h-lvh ">
      <div class="bg-[#48b5a7] text-white  h-lvh flex flex-col justify-center items-center text-center w-[50%] p-8">
      ...
      <div class="bg-white flex flex-col justify-center items-center h-lvh rounded-3xl text-center w-[50%] mr-8 p-8">
        <div class="py-8">
